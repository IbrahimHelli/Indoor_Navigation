...
void getCalibratedAccel(int16_t rawAccelX, int16_t rawAccelY, int16_t rawAccelZ,
  ...
  *calibratedAccelZ = (rawAccelZ - offsetAccelZ) * scaleFactorCorrectionAccelZ;
  ...
  Serial.print(offsetAccelX,5);
  Serial.print(" offsetAccelY: ");
  Serial.print(offsetAccelY,5);
  Serial.print(" offsetAccelZ: ");
  Serial.print(offsetAccelZ,5);

  Serial.print(" scaleAccelX: ");
  Serial.print(scaleFactorCorrectionAccelX,6);
  Serial.print(" scaleAccelY: ");
  Serial.print(scaleFactorCorrectionAccelY,6);
  Serial.print(" scaleAccelZ: ");
  Serial.print(scaleFactorCorrectionAccelZ,6);
}
...
void getCalibratedMag(int16_t rawMagX, int16_t rawMagY, int16_t rawMagZ, int16_t minMagX, int16_t maxMagX, int16_t minMagY, int16_t maxMagY, int16_t minMagZ, int16_t maxMagZ, float *calibratedMagX, float *calibratedMagY, float *calibratedMagZ) {
  ...
  *calibratedMagZ = (rawMagZ - offsetMagZ) * (avgScale / scaleZ);
  ...
  Serial.print(" offsetMagX: ");
  Serial.print(offsetMagX,5);
  Serial.print(" offsetMagY: ");
  Serial.print(offsetMagY,5);
  Serial.print(" offsetMagZ: ");
  Serial.print(offsetMagZ,5);

  Serial.print(" scaleMagX: ");
  Serial.print(avgScale/scaleX,6);
  Serial.print(" scaleMagY: ");
  Serial.print(avgScale/scaleY,6);
  Serial.print(" scaleMagZ: ");
  Serial.print(avgScale/scaleZ,6);
...
void loop() {
  ...
  // Yaw/heading/ baş açısını hesapla
   calculateYaw(filtredAccelX, filtredAccelY, filtredAccelZ, filtredMagX, filtredMagY, filtredMagZ);
